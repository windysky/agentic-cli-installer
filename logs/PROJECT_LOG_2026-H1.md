# PROJECT_LOG archive — 2026-H1 (agentic-cli-installer)
...
- 2026-02-18 — Post-release maintenance (v1.9.0)
- 2026-02-15 — v1.8.1: jq auto-installation for moai-adk
- 2026-02-14 (Evening) — v1.8.0: Windows oh-my-opencode detection and cache fixes
- 2026-02-14 (Afternoon) — v1.7.20: Line ending normalization and version sync
